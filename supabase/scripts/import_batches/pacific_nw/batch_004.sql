...
FROM (
  ...
  ('East Branch Kootenay River', 'Creek', 'freshwater'::public.water_type_enum, ST_SetSRID(ST_MakePoint(-116.65695730861631, 49.223342914698165), 4326)::extensions.geography)
