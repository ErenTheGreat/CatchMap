...
import { useBiteStormAlerts } from '@/hooks/useBiteStormAlerts';
import { isPatternAlertsEnabled, isBiteStormEnabled, isProMonetizationEnabled } from '@/constants/features';
...
function RootLayoutContent() {
  ...
  useBiteStormAlerts(gateStatus === 'complete' && onboardingStatus === 'complete' && isBiteStormEnabled());
  ...
  const showSubscriptionGate =
    isProMonetizationEnabled() && onboardingStatus === 'complete' && gateStatus === 'pending';
