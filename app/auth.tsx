...
export default function AuthScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      hapticSuccess();
      const cloudBackupHint = isCloudSyncFeatureAvailable()
        ? ' — upgrade to Pro to back up catches to the cloud'
        : '';
      showToast({
        message: isSignUp
          ? `Account created${cloudBackupHint}`
          : `Signed in successfully${cloudBackupHint}`,
        variant: 'success',
      });
      router.back();
    } finally {
