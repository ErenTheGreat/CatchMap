    ...
    <View style={styles.container}>
      ...
      {compareSpots.length >= 2 ? (
        <View style={styles.compareSection}>
          <ThemedText style={styles.compareTitle}>Close contenders</ThemedText>
          {compareSpots.map((item) => (
            <TouchableOpacity
              ...
              activeOpacity={0.75}
            >
              <ThemedText style={styles.compareName} numberOfLines={1}>
                {item.spot.name}
              </ThemedText>
              <ThemedText style={styles.compareRating}>
                {item.score.activityRating}/5
              </ThemedText>
              <ThemedText style={styles.compareDistance}>
                {formatDistance(item.spot.distance)}
              </ThemedText>
              {item.score.topSpeciesHint ? (
                <ThemedText style={styles.compareSpecies} numberOfLines={1}>
                  {item.score.topSpeciesHint}
