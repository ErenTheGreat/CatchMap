...
import { Layers, Mic, Navigation, SlidersHorizontal } from 'lucide-react-native';
...
export default function MapOverlayControls({
  ...
  return (
    ...
    >
      ...
      {showCopilot && onCopilotPress ? (
        <Pressable
          style={({ pressed }) => [styles.fab, styles.fabCopilot, pressed && styles.fabPressed]}
          onPress={onCopilotPress}
          accessibilityRole="button"
          accessibilityLabel="On-Water Copilot"
        >
          <Mic color={colors.accentForeground} size={22} />
        </Pressable>
      ) : null}
